...
var name = document.getElementsByName("name")[0].value; if (name.length <= 3)
...
var terms = valueOf('terms');

if (!terms.checked)

return "Please accept the Terms of Service and Privacy Policy"; return "";
